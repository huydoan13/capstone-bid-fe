...
const PaymentSuccessForm = () => {
  ...
  useEffect(() => {
    ...
    axios.put(`https://bids-online.azurewebsites.net/api/Sessions/check_and_update_order?sessionId=${sessionId}&userId=${jsonUser.Id}`,null,{headers: { Authorization: `Bearer ${token}` }})
      .then(response => {
